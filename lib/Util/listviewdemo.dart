...
import 'package:stepperdemo/Util/displaydata.dart';
      ...
      return Container(
        child: Column(
          ...
          children: [
            ...
            Center(child: Text("NO USER DATA FOUND IN DATABASE",style: TextStyle(fontWeight: FontWeight.bold),)),
          ],
        ),
      );
    }
            ...
            return Column(
              children: [
                Padding(
                  ...
                  child: ListTile(
                    onTap: () => {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>displaydata(mob_num:_details[index].mob_num ,)))
                    },
